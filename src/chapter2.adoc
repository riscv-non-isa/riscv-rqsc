...
and is implementation-defined. Each Resource Structure provides an ACPI locator
for the resource governed by that QoS controller.
...
<|- Resource Structure [n]      |-  |24 <a|List of Fixed size Resource Structures associated with
                                             this specific QoS controller.
|===
...
<| PCIe Routing ID             |4   |0   <a|TThe combination of a Segment Number,
