...
has 1 DDR Channel. The DDR Memory is configured in NUMA mode with same
2 proxmity domains where memory controllers 0 and 1 serve cores 0 to 3 and memory controllers
2 adn 3 serve cores 4 to 7.
